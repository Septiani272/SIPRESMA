<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
  <div class="container flex items-center justify-end h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
    ...
    <button class=" p-1 mr-5 -ml-1 rounded-md md:hidden focus:outline-none focus:shadow-outline-purple"
      ...
      <svg class="w-6 h-6" aria-hidden="true" fill="#e57342" viewBox="0 0 20 20">
    ...
    <ul class="flex items-center flex-shrink-2 space-x-6">
      ...
      <li class="flex">
        <button class="rounded-md focus:outline-none focus:shadow-outline-purple" @click="toggleTheme"
          ...
          <template x-if="!dark">
            <svg class="w-5 h-5" aria-hidden="true" fill="#e57342" viewBox="0 0 20 20">
     ...
     <!-- resources/views/user/prestasi/perbaiki.blade.php -->
     @php
     $jumlahPrestasiPerluDiperbaiki = \App\Models\Prestasi::where('status', 'Perlu Diperbaiki')
     ...
     <li class="relative px-4 py-2">
      ...
      <li class="flex">
        <p style="color: #e57342;">{{ Auth::user()->name }}</p>
      </li>
      <!-- Profile menu -->
      <li class="relative">
